...
import queryString from "query-string";
 import { slackApprovalJiraApp } from "./authActions";
 import {createTourInfo,getTourInfo} from '../auth/authActions';
class SlackAuthJira extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      error: ""
  ...
  // console.log("HELLO")
    ...
    this.props
      ...
      .then(response => {
        ...
        window.location.href = `https://slack.com/app_redirect?app=AUHQ16YKA&team=${response.data.team}`
...
export default connect(
  null,
  { slackApprovalJiraApp,createTourInfo,getTourInfo }
)(SlackAuthJira);
